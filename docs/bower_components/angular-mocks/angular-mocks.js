 ...
 *
  ```js
    ...
    describe('MyController', function() {
       ...
       // Set up the module
       beforeEach(module('andrewDesmaraisApp'));
 ...
 *
 * ```js
 *   var andrewDesmaraisAppDev = angular.module('andrewDesmaraisAppDev', ['andrewDesmaraisApp', 'ngMockE2E']);
 *   andrewDesmaraisAppDev.run(function($httpBackend) {
 ...
 *
 * ## Example
 * <example name="httpbackend-e2e-testing" module="andrewDesmaraisAppE2E" deps="angular-mocks.js">
 * <file name="app.js">
 *   var andrewDesmaraisApp = angular.module('andrewDesmaraisApp', []);
 *
 *   andrewDesmaraisApp.controller('MainCtrl', function MainCtrl($http) {
 *     var ctrl = this;
 *
 *     ctrl.phones = [];
 *     ctrl.newPhone = {
 ...
 * </file>
 * <file name="e2e.js">
 *   var andrewDesmaraisAppDev = angular.module('andrewDesmaraisAppE2E', ['andrewDesmaraisApp', 'ngMockE2E']);
 *
 *   andrewDesmaraisAppDev.run(function($httpBackend) {
 *     var phones = [{name: 'phone1'}, {name: 'phone2'}];
 *
...
(function(jasmineOrMocha) {
   ...
   * ```js
   *
   *   angular.module('andrewDesmaraisApplicationModule', [])
   *       .value('mode', 'app')
   *       .value('version', 'v1.0.1');
   *
   *
   *   describe('andrewDesmaraisApp', function() {
   *
   *     // You need to load modules that you want to test,
   *     // it loads only the "ng" module by default.
   *     beforeEach(module('andrewDesmaraisApplicationModule'));
   *
   *
